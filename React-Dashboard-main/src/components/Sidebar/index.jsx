...
import {HiViewGrid,HiOutlineShoppingCart} from 'react-icons/hi'
...
const navigation = [
    ...
    { name: 'Orders', href: '/orders', icon: HiOutlineShoppingCart, current: false },
    { name: 'Meals', href: '/meals', icon: IoFastFood, current: false },
    { name: 'Categories', href: '/categories', icon: BiFoodMenu, current: false },
  ]
...
function SideBar ({ menu, children, logout }) {
            ...
            <main className="flex-1">
              <div className="py-6">
                ...
                <div className="px-4 sm:px-6 md:px-0">
                  ...
                  <div className="py-4">
                    <div className="h-96 p-2 rounded-lg">
                        {children}
                    </div>
                  </div>
                  {/* /End replace */}
