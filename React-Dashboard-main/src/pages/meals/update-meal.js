...
export default function UpdateModal({meal,refresh,setOpen1,open1}) {
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl	 sm:w-full sm:p-6">
              ...
              <div className="sm:flex sm:items-start">
                <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-blue-100 sm:mx-0 sm:h-10 sm:w-10">
                  <AiOutlineEdit className="h-6 w-6 text-blue-600" aria-hidden="true" />
                </div>
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  {!isLoading && <Form refresh={refresh} meal={meal} setOpen1={setOpen1} data={data} mealId={meal.idMeal} />}
...
function Form({mealId, meal, refresh, data, setOpen1}) {
  ...
  const {
    ...
    isSuccess,
    mutate,
  } = useMutation(async (params) => await api_nestjs.post(`/meals/update/${meal.id}`, params),
      {  
        onSuccess : (data) => {
                ...
                <div className="sm:col-span-6">
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      name="meal_image"
                      id="meal_image"
                      defaultValue={meal.strMealThumb}
